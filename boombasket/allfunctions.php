...
function mycart(){
	...
	if(isset($_SESSION['count'])){
		if($_SESSION['count'] > 0){
		    ...
		    echo "<br>";
		    $_SESSION['total'] =$sum;
		    echo "<h4>Your order total is : &#8377;".$sum."  -------->  <a href='placeorder.php' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'> CheckOut </a> </h4>";
	    }
	...
	if($result->num_rows>0)
	{
		...
		echo "
			...
			while($row = mysqli_fetch_assoc($result)){
		        ...
		        echo "<td>&nbsp &nbsp &nbsp</td>";
		        echo "<td valign=middle align=center> &#8377;" . $row['price'] . "</td>";
		        echo "<td>&nbsp &nbsp &nbsp</td>";
		        echo "<td valign=middle align=center>" . $row['payment'] . "</td>";
			echo "<td>&nbsp &nbsp &nbsp</td>";
			echo "<td valign=middle align=center>" . $row['ts'] . "</td>"; 
		        echo "</tr>";
		        }
		    echo "</table>";
		    echo "</form>";
